...
Interact with 'telson' and 'plugsrv' directly from IRB:
  ...
  ## A minor setup step is required... (I stick this in my .irbrc")
  Plug::Blit.blit_init
  #=> nil

  "GET / HTTP/1.0\r\n\r\n".blit
  #=> 28 
  ## Watch your basic HTTP request get made and responded to in the other window...

  ("GET /" + "A"*30 + " HTTP/1.0\r\n\r\n").blit
  #=> 58 
  ## Watch your bogus HTTP request get made and responded to in the other window...
...
I do recommend the more of the rdoc if you're interested in more of these 
little helpers.  Time permitting, I'll try to keep the comments useful and 
up to date. 
