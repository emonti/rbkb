...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_cli_crc32.rb", "test/test_cli_hexify.rb", "test/test_cli_urlenc.rb", "test/test_helper.rb", "test/test_rbkb.rb"]
