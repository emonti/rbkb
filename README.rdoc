...
== Rationale
    ...
    Disclaimer: much of what's in the black bag came from a desire to do less 
    typing
...
Things go into the black bag as they stolen (as a compliment!) or dreamed up, 
usually based on simplifying some repetetive task or desire for a new tool.
...
* Some of the plug stuff also requires ruby pcap available from:
